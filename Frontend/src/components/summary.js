    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ cell }) => {
          ...
          if (cell.getValue() !== "") {
            // Render a clickable element when filepath is not empty
            return <div className="cursor-pointer text-[#fb660d] underline" onClick={ImagePreviewClick}>View</div>;
          } else {
            // Render non-clickable text or any other content when filepath is empty
            return <div className="cursor-pointer text-[#fb660d] underline" onClick={handlePreviewClick1}>View</div>;
          }
    ...
    <div className="bg-white z--10 h-[650px]  overflow-y-auto flex flex-col items-center  w-[1080px] mt-8 filter backdrop-blur-3xl border shadow-[0px_0px_5px] shadow-white">
      <div className="mt-10">
        <div className="flex space-x-2">
          <p className="text-[#fb660d] text-[20px] font-semibold">Data</p>
          <p className="text-[#fb660d] text-[20px] font-semibold">Upto</p>
          <p className="text-[#fb660d] text-[20px] font-semibold">Past</p>
          <p className="text-[#fb660d] text-[20px] font-semibold">Two</p>
          <p className="text-[#fb660d] text-[20px] font-semibold">Months</p>
        </div>
      </div>
      <div className="mt-10 flex-row justify-center text-center text-[15px] text-white w-[840px] bg-[#fb660d]">
        <p>Summary</p>
      </div>
