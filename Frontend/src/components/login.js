      ...
      <div>
        <nav className="bg-[#00a650]">
          <div className="flex flex-row  items-center p-2 space-x-5">
            <img className="h-20 w-20 p-2 rounded-full shadow-[0px_0px_15px] shadow-white" src={logo} alt='logo' />
            <h1 className='text-white text-2xl font-semibold'>OREY NAADU</h1>
          </div>
        </nav>
        <div className=''>
          <div className="flex justify-end right-0 h-full items-center mt-28 mr-16 ">
            <div className="h-[400px] w-[320px] bg-[#00a650] rounded-2xl shadow-5xl border-r-0 border-b-0 border-opacity-30">
              <div className="flex flex-col items-center justify-center space-y-[10px]">
                <div className=" p-1 rounded-full m-10">
                  <div className="rounded-full m-1">
                    <img className="h-10 w-15 rounded-full shadow-[0px_0px_15px] shadow-white bg-blue-500" src={logo} alt="user" />
                  </div>
                </div>
                <div>
                  <form onSubmit={ProceedLogin} className="flex flex-col items-center justify evenly space-y-[25px] m-5">
                    <div className="flex flex-row space-x-3">
                      ...
                      <input
                        ...
                        className="w-[200px] text-sm text-[#fff] placeholder-[#fff] bg-transparent focus:outline-none border border-[#fff] border-r-0 border-t-0 border-l-0"
                      />
                    </div>
                    <div className="flex flex-row space-x-3 ">
                      ...
                      <div>
                        <input
                          ...
                          className="w-[200px] text-sm text-[#fff] placeholder-[#fff] border-[#fff] bg-transparent focus:outline-none border border-r-0 border-t-0 border-l-0 pr-10"
                        />
                        <button
                          type="button"
                          className=" absolute  right-0.7 top-1/6   transform -translate-y-[1.5px]   cursor-pointer  focus:outline-none border-b-[1px] border-[#fff]"
                    ...
                    <button
                      type="submit"
                      className="text-white font-bold  h-8 w-[125px] text-[14px] cursor-pointer font-poppins  rounded-sm bg-[#fb660d] border shadow-[0px_0px_5px] shadow-white"
                    >
                      LOGIN
                    </button>
                    </div>
                ...
                <div className="flex flex-row space-x-[45px] ">
                  <div className="flex flex-row space-x-[3px]">
                    <input type="checkbox" className='text-[#fb660d]' />
                    <p className="text-sm text-[#fff] ">Remember me</p>
                  </div>
                  <button className="text-sm  text-[#fff]" onClick={() => { navigate('/password') }}>Forgot password?</button>
                </div>
