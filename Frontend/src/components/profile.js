    ...
    <div className="flex flex-col content justify-center  bg-white   w-[1080px] space-y-10 mt-8 h-[650px] border shadow-[0px_0px_5px] shadow-white">
      <div className="flex flex-row justify-center space-x-20">
        <div className={`${isEditing ? 'space-y-6' : 'space-y-4'}`}> {/* Adjust the vertical spacing here */}
          {!isEditing && (
            <h1 className="text-[#fb660d] font-bold">Name</h1>
          )}
          {!isEditing && (
            <h1 className="text-[#fb660d] font-bold ">Phone Number</h1>
          )}
          {!isEditing && (
            <h1 className="text-[#fb660d] font-bold">Onboarded Date</h1>
          )}
          <h1 className="text-[#fb660d] font-bold">Email Id</h1>
          <h1 className="text-[#fb660d] font-bold">Category</h1>
          <h1 className="text-[#fb660d] font-bold">Location</h1>
          {isEditing && (
            <h1 className="text-[#fb660d] font-bold">Old Password</h1>
          )}
          {isEditing && (
            <h1 className="text-[#fb660d] font-bold">New Password</h1>
          )}
        </div>
      ...
      <div className="flex justify-end">
        {isEditing ? (
          <>
            <button onClick={handleSave} className="text-white px-4 py-2 mr-12 w-20 rounded-sm btncolor border shadow-[0px_0px_5px] shadow-[#fb660d] ">
              Save
            </button>
          </>
        ) : (
          <>
            <button onClick={handleEdit} className="text-white px-4 py-2 mr-12 w-20 rounded-sm btncolor border shadow-[0px_0px_5px] shadow-[#fb660d] ">
              Edit
            </button>
          </>
        )}
