      ...
      <div className="flex flex-col mt-10 space-y-10 items-center">
        <div className='flex flex-row space-x-10 relative'>
          ...
          <input
            ...
            required
            onChange={handlename}
            className="border border-white w-[400px]  shadow-[0px_0px_5px] shadow-[#fb660d] p-1 focus:outline-none "
          />
        </div>
        ...
        <select  onChange={handleStateChange} value={state} className={`text-[17px] border border-white w-[400px] shadow-[0px_0px_5px] shadow-[#fb660d] p-1 focus:outline-none max-h-[100px] ${state === "" || state==="Select State" ? 'text-gray-400' : 'text-black'}`} >
            ...
            <div className="flex flex-col  absolute top-[180px] left-[417px] z-40">
              ...
              <div
                ...
                className={`  p-2 flex items-center justify-between ${!selected && "text-gray-400"
                  } border border-white w-[402px] shadow-[0px_0px_5px] shadow-[#fb660d]  focus:outline-none `}
              >
                {selected
                  ? selected?.length > 25
              ...
              >
                ...
                {statesData.states.map((stateObj) => (
                  <li
                    key={stateObj.state}
                    className={`p-2 text-sm hover:bg-[#00a650] 
        ...
        <select className={`text-[17px] border border-white w-[400px] p-1 shadow-[0px_0px_5px] shadow-[#fb660d]  focus:outline-none max-h-[100px] ${district === "" || district==="District State" ? 'text-gray-400' : 'text-black'}`}   onChange={handleDistrictChange} value={district}>
            ...
            <div className="flex flex-col  absolute top-[260px] left-[416px] z-10">
              ...
              <div
                ...
                className={`bg-white  p-2 flex items-center justify-between ${!selected1 && "text-gray-400"
                  } border border-white w-[401px] shadow-[0px_0px_5px] shadow-[#fb660d]  focus:outline-none `}
              >
                {selected1
                  ? selected1?.length > 25
        ...
        <div className='flex flex-row space-x-[122px] absolute top-[300px] left-[258px]'>
          ...
          <input
            ...
            value={area}
            onChange={handlearea}
            className="border border-white w-[402px]  shadow-[0px_0px_5px] shadow-[#fb660d] p-1 focus:outline-none "
          />
        </div>
        ...
        <div>
          <div className='flex flex-col space-y-[20px] mt-[199px]'>
            <div className="flex flex-row justify-center  items-center space-x-[40px] ">
              <button className="text-white  h-10 w-52  cursor-pointer  rounded-sm px-5 py-1 btncolor border shadow-[0px_0px_5px] shadow-[#fb660d]" onClick={addcustomer}>Add Customer</button>
            
            </div>
            <div className="flex flex-row space-x-[50px] ml-[60px] rounded-sm w-[300px] p-2 text-white">
            <div><label className="bg-[#fb660d] w-[300px] py-[6px] px-3 rounded-[2px]">Sample Sheet</label></div>
            ...
            <div className="flex  flex-row space-x-10 ml-[50px]">
              <div className="flex flex-row space-x-[485px]">
                ...
                <button
                  ...
                  className="text-white  h-10 w-48  cursor-pointer  rounded-sm px-5 py-1 btncolor border shadow-[0px_0px_5px] shadow-[#fb660d]"
                >
                  Browse
                </button>
              </div>
              <button
                onClick={upload}
                className="text-white  h-10 w-52  mr-2 cursor-pointer  rounded-sm px-5 py-1 btncolor border shadow-[0px_0px_5px] shadow-[#fb660d]"
              >
                upload
              </button>
            </div>
