...
const Sidebar = ({ selectedMenu, setSelectedMenu }) => {
  ...
  return (
    <div className="flex h-full">
      <div className={`bg-[#00a650] h-[100vh] p-5 pt-8 duration-300 relative ${open ? 'w-72' : 'w-20'} `}>
        <BsArrowLeftShort
          className={`bg-white text-[#00203f] text-3xl rounded-full mt-3 top-9 border border-[#f97d09] cursor-pointer transform transition-transform ${!open ? 'rotate-180' : ''
            }`}
          onClick={() => setOpen(!open)}
        />

        <div className="ml-6 mt-3">
          <img className={`h-20 w-20 mx-auto  ${!open ? 'scale-0' : '0'} rounded-full     shadow-[0px_0px_10px]  shadow-white`} src={logo} onClick={() => setSelectedMenu('message')} />
        </div>
        <div className="mt-10 space-y-[150px] h-[350px]">
          <div className="flex flex-row items-center">
            <ul className="ml-6 space-y-8 flex flex-col">
              <li
                className={`text-[#fff] cursor-pointer text-[18px] flex flex-row space-x-4 duration-300   ${!open ? 'scale-0' : '0'} `}
                onClick={() => handleMenuClick('summary')}
              >
                <div className={`${!open ? 'scale-0' : '0'} duration-300  ${selectedMenu === 'summary' ? 'mt-2' : ''}`}>
                  <FontAwesomeIcon icon={faList} className='h-4 ml-2  shadow-[0px_0px_10px]  shadow-[#00a650]' />
                </div>
              ...
              >
                <div className={`${!open ? 'scale-0' : '0'} duration-300 ${selectedMenu === 'report' ? 'mt-2' : ''}`}>
                  <FontAwesomeIcon icon={faBook} className={` ml-2  shadow-[0px_0px_10px] shadow-[#00a650]`} />
              ...
              >
                <div className={`${!open ? 'scale-0' : '0'} duration-300 ${selectedMenu === 'message' ? 'mt-2' : ''}`}>
                  <FontAwesomeIcon icon={faMessage} className='h-4 ml-2  shadow-[0px_0px_10px]   shadow-[#00a650]' />
                </div>
              ...
              >
                <div className={`${!open ? 'scale-0' : '0'} duration-300 ${selectedMenu === 'bulk' ? 'mt-2' : ''}`}>
                  <FontAwesomeIcon icon={faCloudArrowUp} className='h-4 ml-2  shadow-[0px_0px_10px]   shadow-[#00a650]' />
                </div>
              ...
              >
                <div className={`${!open ? 'scale-0' : '0'} duration-300 ${selectedMenu === 'profile' ? 'mt-2' : ''}`}>
                  <FontAwesomeIcon icon={faUser} className='h-4 ml-2  shadow-[0px_0px_10px]  shadow-[#00a650]' />
                </div>
        ...
        <div
          className={`text-[#fff] cursor-pointer ml-6 text-[18px] h-[50px] mt-10 flex flex-row items-center space-x-4 duration-300  ${!open ? 'scale-0' : '0'}`}
          onClick={() => navigate('/login')}
        >
          <div className={`${!open ? 'scale-0' : '0'} duration-300`}>
            <img src={Logout} className='h-8 ml-2  shadow-[0px_0px_10px]  shadow-[#00a650]' />
          </div>
