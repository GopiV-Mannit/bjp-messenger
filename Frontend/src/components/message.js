    ...
    <div className="mt-8 bg-white h-[650px] overflow-y-scroll  w-[1080px] border shadow-[0px_0px_5px] shadow-white">
      ...
      <div className="flex  justify-center p-2 w-full">
        <div className="flex flex-row space-x-[36px]">
          <p className="border border-white w-[800px] text-[#888888] shadow-[0px_0px_5px]  shadow-[#fb660d] p-1 focus:outline-none">{selectedFile.name}</p>
          <input
            type="file"
            accept="image/*"
            id="fileInput"
            ...
            style={{ display: 'none' }}
          />
          <button onClick={() => document.getElementById("fileInput").click()} className='py-1 px-3  rounded-sm text-white flex btncolor border shadow-[0px_0px_5px] shadow-[#fb660d]'>
            Upload
          </button>
          <button onClick={handlePreviewClickImage} className='py-1 px-3  rounded-sm text-white flex btncolor border shadow-[0px_0px_5px] shadow-[#fb660d]'>
            Preview
          </button>
        </div>
        {isImageModalOpen && (
      ...
      <div className="pr-2 pl-2 ml-2 pt-3">
        <button
          className="pb-3 pt-1 px-3 rounded-sm h-[36px] text-white  flex btncolor border shadow-[0px_0px_5px] shadow-[#fb660d]"
      ...
      <div className="flex flex-row justify-end p-8">
        <div className="flex flex-row space-x-10">
          <div className='bg-[#00a650] w-[300px] h-10  rounded-sm font-bold   p-[6px]  text-[#fff]'><h1>Remaining Message Count : {msgCount}</h1></div>
